#This script segregates the categorial data of Innings & Winners into dummy variables

import pandas as pd

match_data = pd.read_csv('dataset.csv')
new_data = match_data[['Margin','Winner']].copy()
feature_cols = list(new_data.columns[0:2])
extra_cols = list(match_data.columns[0:187])
